...
When I change color in renderCreateEventPopup 

I need to show color in events in background in renderWeekView section also and when I hover the events lits need to show details cards with edit and delete functionality also I need
